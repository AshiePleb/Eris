...
module.exports.commands = [{cmd: "prefix", desc: "Change the guild prefix.", perm: ["manageGuild"]}, {cmd: "mentionrole", desc: "Mention a role, regardless mentionable or not.", perm: ["mentionEveryone"]}, {cmd: "mrole", desc: "Alias to `mentionrole`", perm: ["mentionEveryone"]}, {cmd: "autorole", desc: "Manage autorole.", perm: ["manageGuild", "manageRoles"]}, {cmd: "selfrole", desc: "Manage selfrole.", perm: ["manageGuild", "manageRoles"]}, {cmd: "getrole", desc: "Get a selfrole.", perm: ["guildOnly"]}];
...
module.exports.name = "ServerSettings";